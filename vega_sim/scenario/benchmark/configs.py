...
if __name__ == "__main__":
    # Recursively ensure all keys are snake case
    market_config = POINTS_MARKET
    market_config.instrument.future.settlement_asset = "test"
    market_config.instrument.future.quote_name = "test"
    market_config.instrument.future.number_decimal_places = 0
    market_config.instrument.future.terminating_key = "test"
    print(market_config.build())
