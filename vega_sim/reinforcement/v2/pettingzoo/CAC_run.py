...
def train(max_epoch=200,step_per_epoch=500,step_per_collect=2,episode_per_test=9,batch_size=64,update_per_step=0.05,
          ...
          steps_per_trading_session=500, max_action=10,
          load_model=False,model_name='dqn_model_training.pth',resume=False, load_op=True):
    env = None
    ...
    try:
        ...
        reward_fn=lambda rewards: pz.RewardEva(rewards=rewards,print_out=True).cartel()
...
if __name__ == "__main__":
    ...
    train(max_epoch=300,
          ...
          batch_size=128,update_per_step=0.01, n_replay=10000,n_train_collector_init=20,
          load_model=True,model_name='checkpoint.pth', resume=True, load_op=True,
          **common_params_dict
        )
    '''
    train(max_epoch=10,
