...
import vega_protos.protos.vega.commands.v1 as commands_protos
...
from vega_protos.protos.vega.commands.v1.commands_pb2 import ProposalSubmission
...
def propose_market_from_config(
    ...
    changes = market_config.build(oracle_pubkey=pub_key)
