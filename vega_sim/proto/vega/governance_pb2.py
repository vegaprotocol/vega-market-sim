...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    ...
    b" \x01(\tR\tbaseAsset\x12\x1f\n\x0bquote_asset\x18\x02"
    b" \x01(\tR\nquoteAsset\x12\x12\n\x04name\x18\x03"
    b' \x01(\tR\x04name"\x95\x03\n\rFutureProduct\x12)\n\x10settlement_asset\x18\x01'
    b" \x01(\tR\x0fsettlementAsset\x12\x1d\n\nquote_name\x18\x02"
    b" \x01(\tR\tquoteName\x12i\n$data_source_spec_for_settlement_data\x18\x03"
    b" \x01(\x0b\x32\x1a.vega.DataSourceDefinitionR\x1f\x64\x61taSourceSpecForSettlementData\x12q\n(data_source_spec_for_trading_termination\x18\x04"
    b" \x01(\x0b\x32\x1a.vega.DataSourceDefinitionR#dataSourceSpecForTradingTermination\x12\\\n\x18\x64\x61ta_source_spec_binding\x18\x05"
    b' \x01(\x0b\x32#.vega.DataSourceSpecToFutureBindingR\x15\x64\x61taSourceSpecBinding"\xa4\x01\n\x17InstrumentConfiguration\x12\x12\n\x04name\x18\x01'
    b" \x01(\tR\x04name\x12\x12\n\x04\x63ode\x18\x02"
    b" \x01(\tR\x04\x63ode\x12-\n\x06\x66uture\x18\x64"
    b" \x01(\x0b\x32\x13.vega.FutureProductH\x00R\x06\x66uture\x12'\n\x04spot\x18\x65"
    b' \x01(\x0b\x32\x11.vega.SpotProductH\x00R\x04spotB\t\n\x07product"\x8d\x04\n\x1aNewSpotMarketConfiguration\x12=\n\ninstrument\x18\x01'
    b" \x01(\x0b\x32\x1d.vega.InstrumentConfigurationR\ninstrument\x12%\n\x0e\x64\x65\x63imal_places\x18\x02"
    b" \x01(\x04R\rdecimalPlaces\x12\x1a\n\x08metadata\x18\x03"
    b" \x03(\tR\x08metadata\x12_\n\x1bprice_monitoring_parameters\x18\x04"
    b" \x01(\x0b\x32\x1f.vega.PriceMonitoringParametersR\x19priceMonitoringParameters\x12S\n\x17target_stake_parameters\x18\x05"
    b" \x01(\x0b\x32\x1b.vega.TargetStakeParametersR\x15targetStakeParameters\x12\x31\n\x06simple\x18\x64"
    b" \x01(\x0b\x32\x17.vega.SimpleModelParamsH\x00R\x06simple\x12\x39\n\nlog_normal\x18\x65"
    b" \x01(\x0b\x32\x18.vega.LogNormalRiskModelH\x00R\tlogNormal\x12\x36\n\x17position_decimal_places\x18\x06"
    b' \x01(\x03R\x15positionDecimalPlacesB\x11\n\x0frisk_parameters"\x88\x06\n\x16NewMarketConfiguration\x12=\n\ninstrument\x18\x01'
    b" \x01(\x0b\x32\x1d.vega.InstrumentConfigurationR\ninstrument\x12%\n\x0e\x64\x65\x63imal_places\x18\x02"
    b" \x01(\x04R\rdecimalPlaces\x12\x1a\n\x08metadata\x18\x03"
    b" \x03(\tR\x08metadata\x12_\n\x1bprice_monitoring_parameters\x18\x04"
    b" \x01(\x0b\x32\x1f.vega.PriceMonitoringParametersR\x19priceMonitoringParameters\x12k\n\x1fliquidity_monitoring_parameters\x18\x05"
    b" \x01(\x0b\x32#.vega.LiquidityMonitoringParametersR\x1dliquidityMonitoringParameters\x12\x31\n\x06simple\x18\x64"
    b" \x01(\x0b\x32\x17.vega.SimpleModelParamsH\x00R\x06simple\x12\x39\n\nlog_normal\x18\x65"
    b" \x01(\x0b\x32\x18.vega.LogNormalRiskModelH\x00R\tlogNormal\x12\x36\n\x17position_decimal_places\x18\x06"
    b" \x01(\x03R\x15positionDecimalPlaces\x12$\n\x0elp_price_range\x18\x08"
    b" \x01(\tR\x0clpPriceRange\x12\x34\n\x16linear_slippage_factor\x18\t"
    b" \x01(\tR\x14linearSlippageFactor\x12:\n\x19quadratic_slippage_factor\x18\n"
    b" \x01(\tR\x17quadraticSlippageFactor\x12?\n\tsuccessor\x18\x0b"
    b' \x01(\x0b\x32\x1c.vega.SuccessorConfigurationH\x01R\tsuccessor\x88\x01\x01\x42\x11\n\x0frisk_parametersB\x0c\n\n_successor"K\n\rNewSpotMarket\x12:\n\x07\x63hanges\x18\x01'
    b" \x01(\x0b\x32"
    b' .vega.NewSpotMarketConfigurationR\x07\x63hanges"z\n\x16SuccessorConfiguration\x12(\n\x10parent_market_id\x18\x01'
    b" \x01(\tR\x0eparentMarketId\x12\x36\n\x17insurance_pool_fraction\x18\x02"
    b' \x01(\tR\x15insurancePoolFraction"C\n\tNewMarket\x12\x36\n\x07\x63hanges\x18\x01'
    b' \x01(\x0b\x32\x1c.vega.NewMarketConfigurationR\x07\x63hanges"f\n\x0cUpdateMarket\x12\x1b\n\tmarket_id\x18\x01'
    b" \x01(\tR\x08marketId\x12\x39\n\x07\x63hanges\x18\x02"
    b' \x01(\x0b\x32\x1f.vega.UpdateMarketConfigurationR\x07\x63hanges"n\n\x10UpdateSpotMarket\x12\x1b\n\tmarket_id\x18\x01'
    b" \x01(\tR\x08marketId\x12=\n\x07\x63hanges\x18\x02"
    b' \x01(\x0b\x32#.vega.UpdateSpotMarketConfigurationR\x07\x63hanges"\xe3\x04\n\x19UpdateMarketConfiguration\x12\x43\n\ninstrument\x18\x01'
    b" \x01(\x0b\x32#.vega.UpdateInstrumentConfigurationR\ninstrument\x12\x1a\n\x08metadata\x18\x02"
    b" \x03(\tR\x08metadata\x12_\n\x1bprice_monitoring_parameters\x18\x03"
    b" \x01(\x0b\x32\x1f.vega.PriceMonitoringParametersR\x19priceMonitoringParameters\x12k\n\x1fliquidity_monitoring_parameters\x18\x04"
    b" \x01(\x0b\x32#.vega.LiquidityMonitoringParametersR\x1dliquidityMonitoringParameters\x12\x31\n\x06simple\x18\x64"
    b" \x01(\x0b\x32\x17.vega.SimpleModelParamsH\x00R\x06simple\x12\x39\n\nlog_normal\x18\x65"
    b" \x01(\x0b\x32\x18.vega.LogNormalRiskModelH\x00R\tlogNormal\x12$\n\x0elp_price_range\x18\x05"
    b" \x01(\tR\x0clpPriceRange\x12\x34\n\x16linear_slippage_factor\x18\x06"
    b" \x01(\tR\x14linearSlippageFactor\x12:\n\x19quadratic_slippage_factor\x18\x07"
    b' \x01(\tR\x17quadraticSlippageFactorB\x11\n\x0frisk_parameters"\xf2\x02\n\x1dUpdateSpotMarketConfiguration\x12\x1a\n\x08metadata\x18\x01'
    b" \x03(\tR\x08metadata\x12_\n\x1bprice_monitoring_parameters\x18\x02"
    b" \x01(\x0b\x32\x1f.vega.PriceMonitoringParametersR\x19priceMonitoringParameters\x12S\n\x17target_stake_parameters\x18\x03"
    b" \x01(\x0b\x32\x1b.vega.TargetStakeParametersR\x15targetStakeParameters\x12\x31\n\x06simple\x18\x64"
    b" \x01(\x0b\x32\x17.vega.SimpleModelParamsH\x00R\x06simple\x12\x39\n\nlog_normal\x18\x65"
    b' \x01(\x0b\x32\x18.vega.LogNormalRiskModelH\x00R\tlogNormalB\x11\n\x0frisk_parameters"s\n\x1dUpdateInstrumentConfiguration\x12\x12\n\x04\x63ode\x18\x01'
    b" \x01(\tR\x04\x63ode\x12\x33\n\x06\x66uture\x18\x64"
    b' \x01(\x0b\x32\x19.vega.UpdateFutureProductH\x00R\x06\x66utureB\t\n\x07product"\xf0\x02\n\x13UpdateFutureProduct\x12\x1d\n\nquote_name\x18\x01'
    b" \x01(\tR\tquoteName\x12i\n$data_source_spec_for_settlement_data\x18\x02"
    b" \x01(\x0b\x32\x1a.vega.DataSourceDefinitionR\x1f\x64\x61taSourceSpecForSettlementData\x12q\n(data_source_spec_for_trading_termination\x18\x03"
    b" \x01(\x0b\x32\x1a.vega.DataSourceDefinitionR#dataSourceSpecForTradingTermination\x12\\\n\x18\x64\x61ta_source_spec_binding\x18\x04"
    b' \x01(\x0b\x32#.vega.DataSourceSpecToFutureBindingR\x15\x64\x61taSourceSpecBinding"J\n\x16UpdateNetworkParameter\x12\x30\n\x07\x63hanges\x18\x01'
    b' \x01(\x0b\x32\x16.vega.NetworkParameterR\x07\x63hanges"8\n\x08NewAsset\x12,\n\x07\x63hanges\x18\x01'
    b' \x01(\x0b\x32\x12.vega.AssetDetailsR\x07\x63hanges"\\\n\x0bUpdateAsset\x12\x19\n\x08\x61sset_id\x18\x01'
    b" \x01(\tR\x07\x61ssetId\x12\x32\n\x07\x63hanges\x18\x02"
    b' \x01(\x0b\x32\x18.vega.AssetDetailsUpdateR\x07\x63hanges"\r\n\x0bNewFreeform"\xdb\x06\n\rProposalTerms\x12+\n\x11\x63losing_timestamp\x18\x01'
    b" \x01(\x03R\x10\x63losingTimestamp\x12/\n\x13\x65nactment_timestamp\x18\x02"
    b" \x01(\x03R\x12\x65nactmentTimestamp\x12\x31\n\x14validation_timestamp\x18\x03"
    b" \x01(\x03R\x13validationTimestamp\x12\x39\n\rupdate_market\x18\x65"
    b" \x01(\x0b\x32\x12.vega.UpdateMarketH\x00R\x0cupdateMarket\x12\x30\n\nnew_market\x18\x66"
    b" \x01(\x0b\x32\x0f.vega.NewMarketH\x00R\tnewMarket\x12X\n\x18update_network_parameter\x18g"
    b" \x01(\x0b\x32\x1c.vega.UpdateNetworkParameterH\x00R\x16updateNetworkParameter\x12-\n\tnew_asset\x18h"
    b" \x01(\x0b\x32\x0e.vega.NewAssetH\x00R\x08newAsset\x12\x36\n\x0cnew_freeform\x18i"
    b" \x01(\x0b\x32\x11.vega.NewFreeformH\x00R\x0bnewFreeform\x12\x36\n\x0cupdate_asset\x18j"
    b" \x01(\x0b\x32\x11.vega.UpdateAssetH\x00R\x0bupdateAsset\x12=\n\x0fnew_spot_market\x18k"
    b" \x01(\x0b\x32\x13.vega.NewSpotMarketH\x00R\rnewSpotMarket\x12\x46\n\x12update_spot_market\x18l"
    b" \x01(\x0b\x32\x16.vega.UpdateSpotMarketH\x00R\x10updateSpotMarket\x12\x36\n\x0cnew_transfer\x18m"
    b" \x01(\x0b\x32\x11.vega.NewTransferH\x00R\x0bnewTransfer\x12?\n\x0f\x63\x61ncel_transfer\x18n"
    b" \x01(\x0b\x32\x14.vega.CancelTransferH\x00R\x0e\x63\x61ncelTransfer\x12I\n\x13update_market_state\x18o"
    b' \x01(\x0b\x32\x17.vega.UpdateMarketStateH\x00R\x11updateMarketStateB\x08\n\x06\x63hange"W\n\x11ProposalRationale\x12'
    b" \n\x0b\x64\x65scription\x18\x01"
    b" \x01(\tR\x0b\x64\x65scription\x12\x14\n\x05title\x18\x04"
    b' \x01(\tR\x05titleJ\x04\x08\x02\x10\x03J\x04\x08\x03\x10\x04"\x86\x03\n\x0eGovernanceData\x12*\n\x08proposal\x18\x01'
    b" \x01(\x0b\x32\x0e.vega.ProposalR\x08proposal\x12\x1c\n\x03yes\x18\x02"
    b" \x03(\x0b\x32\n.vega.VoteR\x03yes\x12\x1a\n\x02no\x18\x03"
    b" \x03(\x0b\x32\n.vega.VoteR\x02no\x12?\n\tyes_party\x18\x04"
    b' \x03(\x0b\x32".vega.GovernanceData.YesPartyEntryR\x08yesParty\x12<\n\x08no_party\x18\x05'
    b" \x03(\x0b\x32!.vega.GovernanceData.NoPartyEntryR\x07noParty\x1aG\n\rYesPartyEntry\x12\x10\n\x03key\x18\x01"
    b" \x01(\tR\x03key\x12 \n\x05value\x18\x02"
    b" \x01(\x0b\x32\n.vega.VoteR\x05value:\x02\x38\x01\x1a\x46\n\x0cNoPartyEntry\x12\x10\n\x03key\x18\x01"
    b" \x01(\tR\x03key\x12 \n\x05value\x18\x02"
    b' \x01(\x0b\x32\n.vega.VoteR\x05value:\x02\x38\x01"\x9a\x07\n\x08Proposal\x12\x0e\n\x02id\x18\x01'
    b" \x01(\tR\x02id\x12\x1c\n\treference\x18\x02"
    b" \x01(\tR\treference\x12\x19\n\x08party_id\x18\x03"
    b" \x01(\tR\x07partyId\x12*\n\x05state\x18\x04"
    b" \x01(\x0e\x32\x14.vega.Proposal.StateR\x05state\x12\x1c\n\ttimestamp\x18\x05"
    b" \x01(\x03R\ttimestamp\x12)\n\x05terms\x18\x06"
    b" \x01(\x0b\x32\x13.vega.ProposalTermsR\x05terms\x12\x30\n\x06reason\x18\x07"
    b" \x01(\x0e\x32\x13.vega.ProposalErrorH\x00R\x06reason\x88\x01\x01\x12(\n\rerror_details\x18\x08"
    b" \x01(\tH\x01R\x0c\x65rrorDetails\x88\x01\x01\x12\x35\n\trationale\x18\t"
    b" \x01(\x0b\x32\x17.vega.ProposalRationaleR\trationale\x12\x35\n\x16required_participation\x18\n"
    b" \x01(\tR\x15requiredParticipation\x12+\n\x11required_majority\x18\x0b"
    b" \x01(\tR\x10requiredMajority\x12^\n)required_liquidity_provider_participation\x18\x0c"
    b" \x01(\tH\x02R&requiredLiquidityProviderParticipation\x88\x01\x01\x12T\n$required_liquidity_provider_majority\x18\r"
    b' \x01(\tH\x03R!requiredLiquidityProviderMajority\x88\x01\x01"\xae\x01\n\x05State\x12\x15\n\x11STATE_UNSPECIFIED\x10\x00\x12\x10\n\x0cSTATE_FAILED\x10\x01\x12\x0e\n\nSTATE_OPEN\x10\x02\x12\x10\n\x0cSTATE_PASSED\x10\x03\x12\x12\n\x0eSTATE_REJECTED\x10\x04\x12\x12\n\x0eSTATE_DECLINED\x10\x05\x12\x11\n\rSTATE_ENACTED\x10\x06\x12\x1f\n\x1bSTATE_WAITING_FOR_NODE_VOTE\x10\x07\x42\t\n\x07_reasonB\x10\n\x0e_error_detailsB,\n*_required_liquidity_provider_participationB\'\n%_required_liquidity_provider_majority"\x91\x03\n\x04Vote\x12\x19\n\x08party_id\x18\x01'
    b" \x01(\tR\x07partyId\x12&\n\x05value\x18\x02"
    b" \x01(\x0e\x32\x10.vega.Vote.ValueR\x05value\x12\x1f\n\x0bproposal_id\x18\x03"
    b" \x01(\tR\nproposalId\x12\x1c\n\ttimestamp\x18\x04"
    b" \x01(\x03R\ttimestamp\x12\x43\n\x1etotal_governance_token_balance\x18\x05"
    b" \x01(\tR\x1btotalGovernanceTokenBalance\x12\x41\n\x1dtotal_governance_token_weight\x18\x06"
    b" \x01(\tR\x1atotalGovernanceTokenWeight\x12\x42\n\x1etotal_equity_like_share_weight\x18\x07"
    b' \x01(\tR\x1atotalEquityLikeShareWeight";\n\x05Value\x12\x15\n\x11VALUE_UNSPECIFIED\x10\x00\x12\x0c\n\x08VALUE_NO\x10\x01\x12\r\n\tVALUE_YES\x10\x02"S\n\x11UpdateMarketState\x12>\n\x07\x63hanges\x18\x01'
    b' \x01(\x0b\x32$.vega.UpdateMarketStateConfigurationR\x07\x63hanges"\xa0\x01\n\x1eUpdateMarketStateConfiguration\x12\x1b\n\tmarket_id\x18\x01'
    b" \x01(\tR\x08marketId\x12<\n\x0bupdate_type\x18\x02"
    b" \x01(\x0e\x32\x1b.vega.MarketStateUpdateTypeR\nupdateType\x12\x19\n\x05price\x18\x03"
    b' \x01(\tH\x00R\x05price\x88\x01\x01\x42\x08\n\x06_price"M\n\x0e\x43\x61ncelTransfer\x12;\n\x07\x63hanges\x18\x01'
    b' \x01(\x0b\x32!.vega.CancelTransferConfigurationR\x07\x63hanges">\n\x1b\x43\x61ncelTransferConfiguration\x12\x1f\n\x0btransfer_id\x18\x01'
    b' \x01(\tR\ntransferId"G\n\x0bNewTransfer\x12\x38\n\x07\x63hanges\x18\x01'
    b' \x01(\x0b\x32\x1e.vega.NewTransferConfigurationR\x07\x63hanges"\xd9\x03\n\x18NewTransferConfiguration\x12\x32\n\x0bsource_type\x18\x01'
    b" \x01(\x0e\x32\x11.vega.AccountTypeR\nsourceType\x12\x16\n\x06source\x18\x02"
    b" \x01(\tR\x06source\x12\x41\n\rtransfer_type\x18\x03"
    b" \x01(\x0e\x32\x1c.vega.GovernanceTransferTypeR\x0ctransferType\x12\x16\n\x06\x61mount\x18\x04"
    b" \x01(\tR\x06\x61mount\x12\x14\n\x05\x61sset\x18\x05"
    b" \x01(\tR\x05\x61sset\x12.\n\x13\x66raction_of_balance\x18\x06"
    b" \x01(\tR\x11\x66ractionOfBalance\x12<\n\x10\x64\x65stination_type\x18\x07"
    b" \x01(\x0e\x32\x11.vega.AccountTypeR\x0f\x64\x65stinationType\x12"
    b" \n\x0b\x64\x65stination\x18\x08"
    b" \x01(\tR\x0b\x64\x65stination\x12/\n\x07one_off\x18\x65"
    b" \x01(\x0b\x32\x14.vega.OneOffTransferH\x00R\x06oneOff\x12\x37\n\trecurring\x18\x66"
    b' \x01(\x0b\x32\x17.vega.RecurringTransferH\x00R\trecurringB\x06\n\x04kind"/\n\x0eOneOffTransfer\x12\x1d\n\ndeliver_on\x18\x01'
    b' \x01(\x03R\tdeliverOn"d\n\x11RecurringTransfer\x12\x1f\n\x0bstart_epoch\x18\x01'
    b" \x01(\x04R\nstartEpoch\x12 \n\tend_epoch\x18\x02"
