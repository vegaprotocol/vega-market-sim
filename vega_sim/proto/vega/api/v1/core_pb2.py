...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    ...
    b" \x01(\x0c\x42\x04\xe2\x41\x01\x02R\x05\x65vent\x12\x1d\n\x07pub_key\x18\x02"
    b' \x01(\tB\x04\xe2\x41\x01\x02R\x06pubKey\x12"\n\tsignature\x18\x03'
    b' \x01(\x0c\x42\x04\xe2\x41\x01\x02R\tsignature"7\n\x1bPropagateChainEventResponse\x12\x18\n\x07success\x18\x01'
    b' \x01(\x08R\x07success"\xe3\x01\n\x18SubmitTransactionRequest\x12\x33\n\x02tx\x18\x01'
    b" \x01(\x0b\x32\x1d.vega.commands.v1.TransactionB\x04\xe2\x41\x01\x02R\x02tx\x12\x44\n\x04type\x18\x02"
    b' \x01(\x0e\x32*.vega.api.v1.SubmitTransactionRequest.TypeB\x04\xe2\x41\x01\x02R\x04type"L\n\x04Type\x12\x14\n\x10TYPE_UNSPECIFIED\x10\x00\x12\x0e\n\nTYPE_ASYNC\x10\x01\x12\r\n\tTYPE_SYNC\x10\x02\x12\x0f\n\x0bTYPE_COMMIT\x10\x03"\xa0\x01\n\x19SubmitTransactionResponse\x12\x18\n\x07success\x18\x01'
    ...
    b' \x01(\x03R\x06height"N\n\x17\x43heckTransactionRequest\x12\x33\n\x02tx\x18\x01'
    b' \x01(\x0b\x32\x1d.vega.commands.v1.TransactionB\x04\xe2\x41\x01\x02R\x02tx"\xbc\x01\n\x18\x43heckTransactionResponse\x12\x18\n\x07success\x18\x01'
    ...
    b' \x01(\tR\x04info"\xca\x01\n\x1bSubmitRawTransactionRequest\x12\x14\n\x02tx\x18\x01'
    b" \x01(\x0c\x42\x04\xe2\x41\x01\x02R\x02tx\x12G\n\x04type\x18\x02"
    b' \x01(\x0e\x32-.vega.api.v1.SubmitRawTransactionRequest.TypeB\x04\xe2\x41\x01\x02R\x04type"L\n\x04Type\x12\x14\n\x10TYPE_UNSPECIFIED\x10\x00\x12\x0e\n\nTYPE_ASYNC\x10\x01\x12\r\n\tTYPE_SYNC\x10\x02\x12\x0f\n\x0bTYPE_COMMIT\x10\x03"\xa3\x01\n\x1cSubmitRawTransactionResponse\x12\x18\n\x07success\x18\x01'
    b" \x01(\x08R\x07success\x12\x17\n\x07tx_hash\x18\x02"
    b" \x01(\tR\x06txHash\x12\x12\n\x04\x63ode\x18\x03"
    b" \x01(\rR\x04\x63ode\x12\x12\n\x04\x64\x61ta\x18\x04"
    b" \x01(\tR\x04\x64\x61ta\x12\x10\n\x03log\x18\x05"
    b" \x01(\tR\x03log\x12\x16\n\x06height\x18\x06"
    b' \x01(\x03R\x06height"2\n\x1a\x43heckRawTransactionRequest\x12\x14\n\x02tx\x18\x01'
    b' \x01(\x0c\x42\x04\xe2\x41\x01\x02R\x02tx"\xbf\x01\n\x1b\x43heckRawTransactionResponse\x12\x18\n\x07success\x18\x01'
    b" \x01(\x08R\x07success\x12\x12\n\x04\x63ode\x18\x02"
    b" \x01(\rR\x04\x63ode\x12\x1d\n\ngas_wanted\x18\x03"
    b" \x01(\x03R\tgasWanted\x12\x19\n\x08gas_used\x18\x04"
    b" \x01(\x03R\x07gasUsed\x12\x12\n\x04\x64\x61ta\x18\x05"
    ...
    b" \x01(\tR\x0f\x65pochExpiryTime\x12\x1f\n\x0b\x65vent_count\x18'"
    b" \x01(\x04R\neventCount\x12*\n\x11\x65vents_per_second\x18("
    b' \x01(\x04R\x0f\x65ventsPerSecond"\x18\n\x16LastBlockHeightRequest"\x91\x03\n\x17LastBlockHeightResponse\x12\x16\n\x06height\x18\x01'
    ...
    b' \x01(\tR\x11minTokensRequired"\xe8\x02\n\rPoWBlockState\x12!\n\x0c\x62lock_height\x18\x01'
    ...
    b" \x01(\tR\x0chashFunction\x12\x1e\n\ndifficulty\x18\x06"
    b" \x01(\x04R\ndifficulty\x12 \n\x0ctx_per_block\x18\x07"
    b" \x01(\x04R\ntxPerBlock\x12\x33\n\x15increasing_difficulty\x18\x08"
    b' \x01(\x08R\x14increasingDifficultyB\x16\n\x14_expected_difficulty"\xb9\x01\n\x0cPoWStatistic\x12=\n\x0c\x62lock_states\x18\x01'
    b" \x03(\x0b\x32\x1a.vega.api.v1.PoWBlockStateR\x0b\x62lockStates\x12&\n\x0c\x62\x61nned_until\x18\x02"
    b" \x01(\tH\x00R\x0b\x62\x61nnedUntil\x88\x01\x01\x12\x31\n\x15number_of_past_blocks\x18\x03"
    b' \x01(\x04R\x12numberOfPastBlocksB\x0f\n\r_banned_until"\xd5\x03\n\x0eSpamStatistics\x12\x38\n\tproposals\x18\x01'
    ...
    b" \x01(\x0b\x32\x19.vega.api.v1.PoWStatisticR\x03pow\x12\x45\n\x10issue_signatures\x18\x07"
    b" \x01(\x0b\x32\x1a.vega.api.v1.SpamStatisticR\x0fissueSignatures\x12\x1b\n\tepoch_seq\x18\x08"
    b' \x01(\x04R\x08\x65pochSeq"s\n\x19GetSpamStatisticsResponse\x12\x19\n\x08\x63hain_id\x18\x01'
    ...
    b" core APIs2\x07v0.71.0\x1a\x13lb.testnet.vega.xyz*\x02\x01\x02\x62\x06proto3"
)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = (
        ...
        b" APIs2\007v0.72.1\032\023lb.testnet.vega.xyz*\002\001\002"
    )
    _PROPAGATECHAINEVENTREQUEST.fields_by_name["event"]._options = None
    _PROPAGATECHAINEVENTREQUEST.fields_by_name["event"]._serialized_options = (
        b"\342A\001\002"
    )
    _PROPAGATECHAINEVENTREQUEST.fields_by_name["pub_key"]._options = None
    _PROPAGATECHAINEVENTREQUEST.fields_by_name["pub_key"]._serialized_options = (
        b"\342A\001\002"
    )
    _PROPAGATECHAINEVENTREQUEST.fields_by_name["signature"]._options = None
    _PROPAGATECHAINEVENTREQUEST.fields_by_name["signature"]._serialized_options = (
        b"\342A\001\002"
    )
    _SUBMITTRANSACTIONREQUEST.fields_by_name["tx"]._options = None
    _SUBMITTRANSACTIONREQUEST.fields_by_name["tx"]._serialized_options = (
        b"\342A\001\002"
    )
    _SUBMITTRANSACTIONREQUEST.fields_by_name["type"]._options = None
    _SUBMITTRANSACTIONREQUEST.fields_by_name["type"]._serialized_options = (
        b"\342A\001\002"
    )
    ...
    _SUBMITRAWTRANSACTIONREQUEST.fields_by_name["tx"]._serialized_options = (
        b"\342A\001\002"
    )
    _SUBMITRAWTRANSACTIONREQUEST.fields_by_name["type"]._options = None
    _SUBMITRAWTRANSACTIONREQUEST.fields_by_name["type"]._serialized_options = (
        b"\342A\001\002"
    )
    _CHECKRAWTRANSACTIONREQUEST.fields_by_name["tx"]._options = None
    _CHECKRAWTRANSACTIONREQUEST.fields_by_name["tx"]._serialized_options = (
        b"\342A\001\002"
    )
    _GETSPAMSTATISTICSREQUEST.fields_by_name["party_id"]._options = None
    _GETSPAMSTATISTICSREQUEST.fields_by_name["party_id"]._serialized_options = (
        b"\342A\001\002"
    )
