...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals["DESCRIPTOR"]._serialized_options = (
        b"Z,code.vegaprotocol.io/vega/protos/vega/api/v1\222A4\022\031\n\016Vega core APIs2\007v0.74.3\032\023lb.testnet.vega.xyz*\002\001\002"
    )
