...
OracleSpecConfiguration = _reflection.GeneratedProtocolMessageType(
...
OracleSpec = _reflection.GeneratedProtocolMessageType(
    "OracleSpec",
    (_message.Message,),
    {
...
PropertyKey = _reflection.GeneratedProtocolMessageType(
    "PropertyKey",
    (_message.Message,),
    {
