...
class AMM(_message.Message):
    ...
    class Curve(_message.Message):
        __slots__ = ("virtual_liquidity", "theoretical_position")
        VIRTUAL_LIQUIDITY_FIELD_NUMBER: _ClassVar[int]
        THEORETICAL_POSITION_FIELD_NUMBER: _ClassVar[int]
        virtual_liquidity: str
        theoretical_position: str
        def __init__(
            self,
            virtual_liquidity: _Optional[str] = ...,
            theoretical_position: _Optional[str] = ...,
        ) -> None: ...
