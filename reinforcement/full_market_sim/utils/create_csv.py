...
def createfile_MMmodel(
    strategy='A_S_MMmodel_sim.csv'
):
    """
...
def createfile_multiLPs(
    ...
    header = (
        header + header_GA + header_MA 
        + header_BA + header_PNL + header_Re 
        + header_Un + header_Pos + header_bid 
        + header_ask + header_entry + header_els
    )
